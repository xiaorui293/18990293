...
import com.wythe.mall.view.mall.adapter.ProductGridItem;
import com.wythe.mall.view.mall.adapter.ProductListItem;
...
public class ProductActivity extends BaseActivity {
    ...
    private void initData(){
        ...
        gridItems.add(new ProductGridItem("","手机(003)","¥23156.90","","手机(003)","¥23156.90"));
        gridItems.add(new ProductGridItem("","手机(003)","¥23156.90","","手机(003)","¥23156.90"));
        gridItems.add(new ProductGridItem("","手机(003)","¥23156.90","","手机(003)","¥23156.90"));
        gridItems.add(new ProductGridItem("","手机(003)","¥23156.90","","手机(003)","¥23156.90"));
        gridItems.add(new ProductGridItem("","手机(003)","¥23156.90","","手机(003)","¥23156.90"));
