...
import com.wythe.mall.MainActivity2;
...
public class PageFrameLayout extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    public void setUpViews(int layoutIds[], int dot_on, int dot_off) {
        System.out.println("xxoo3");
        this.dot_on = dot_on;
        this.dot_off = dot_off;
        System.out.println("xxoo4");
        ...
        System.out.println("xxoo5");
        LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(
                LinearLayout.LayoutParams.WRAP_CONTENT,
                LinearLayout.LayoutParams.WRAP_CONTENT);
        lp.setMargins(8, 0, 8, 0);
        System.out.println("xxoo6");
        ...
        System.out.println("xxoo7");
        setSelectVp(0);
        MainActivity2 activity = (MainActivity2) getContext();
